/***************************************************************************
                                tcpsocket.cpp
                             -------------------
	revision             : $Id: tcpsocket.cpp,v 1.1.1.1 2003/02/21 16:12:49 wiz Exp $
...
bool TcpSocket::NameToAddr( const char *name, struct sockaddr **addr, socklen_t *len )
{
	...
	*len  = sizeof( AddrBuf );
	...
	AddrBuf.sin_addr.s_addr = inet_addr( name );

    ret = AddrBuf.sin_addr.s_addr != INADDR_NONE;
#endif
