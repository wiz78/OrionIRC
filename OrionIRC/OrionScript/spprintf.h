...
/* $Id: spprintf.h,v 1.1 2005/01/22 00:27:37 wiz Exp $ */
...
BEGIN_EXTERN_C()
int spprintf( char **pbuf, size_t max_len, const char *format, ...) ZEND_ATTRIBUTE_FORMAT(printf, 3, 4);

int vspprintf(char **pbuf, size_t max_len, const char *format, va_list ap) ZEND_ATTRIBUTE_FORMAT(printf, 3, 0);
END_EXTERN_C()
