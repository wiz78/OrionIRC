...
/* $Id: snprintf.h,v 1.1 2005/01/22 00:27:37 wiz Exp $ */
...
int ap_php_snprintf(char *, size_t, const char *, ...) ZEND_ATTRIBUTE_FORMAT(printf, 3, 4);
#ifdef snprintf
#undef snprintf
#endif
#define snprintf ap_php_snprintf

PHPAPI int ap_php_vsnprintf(char *, size_t, const char *, va_list ap) ZEND_ATTRIBUTE_FORMAT(printf, 3, 0);
#ifdef vsnprintf
#undef vsnprintf
#endif
#define vsnprintf ap_php_vsnprintf

PHPAPI int php_sprintf (char* s, const char* format, ...) ZEND_ATTRIBUTE_FORMAT(printf, 2, 3);
#ifdef sprintf
#undef sprintf
#endif
