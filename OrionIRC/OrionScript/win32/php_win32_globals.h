...
/* $Id: php_win32_globals.h,v 1.1 2005/01/22 15:07:28 wiz Exp $ */
...
#else
# define PW32G(v)		(php_win32_core_globals_.v)
extern PHPAPI struct _php_win32_core_globals php_win32_core_globals_;
#endif
